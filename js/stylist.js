...
(function () {
  ...
  // results screen + header back arrow
  const screenResults    = $("screen-results");
  const hdrBack          = $("hdrBack");
  ...
  /* ---------------------------------------------------------
     Header back arrow → start over (full reload)
     --------------------------------------------------------- */
  hdrBack.addEventListener("click", () => location.reload());
  ...
  /* ---------------------------------------------------------
     DEV — Test Mode (only visible when running from file://)
     skips the upload/analyse/match flow entirely
     --------------------------------------------------------- */
  const TEST_ANALYSIS = {
    outfit_type: "saree",
    dominant_colour: "grey",
    colour_family: "neutral",
    colour_tone: "dark",
    neckline: "v-neck",
    style_weight: "heavy",
    western_or_ethnic: "ethnic",
    occasion_confirmed: "wedding",
    border_or_embellishment: "heavy embellishment",
    colour_accents: ["silver"],
    image_quality: "good",
  };

  const TEST_MATCH = {
    stylist_reading:
      "A heavily embellished grey saree with silver accents calls for statement jewellery that complements its richness without overpowering it. Given the V-neckline and wedding occasion, a statement necklace or striking earrings paired with a complementary accent piece would create a cohesive and glamorous look.",
    recommendations: [
      {
        product_id: "10869",
        title: "Rajnandini – Temple Meenakari Statement Necklace Set",
        type: "neck",
        tier: 1,
        reason:
          "This statement necklace set features intricate meenakari enamel in deep green and ruby accents, which will beautifully contrast with the grey saree. The antique gold finish and cascading chain tassels add the perfect amount of traditional grandeur for a wedding.",
        match_score: 95,
        price: 7365,
        image_url: "https://ruhratna.com/wp-content/uploads/2026/04/123.webp",
        product_url: "https://ruhratna.com/shop/rajnandini-temple-meenakari-statement-necklace-set/",
      },
      {
        product_id: "10853",
        title: "Vasundhara – Temple Kundan Heritage Choker Set",
        type: "neck",
        tier: 1,
        reason:
          "The structured choker silhouette of this set will perfectly complement the V-neckline of the saree. The temple-inspired motifs and subtle kundan stones in ruby and emerald tones will add a rich, heritage feel suitable for a wedding.",
        match_score: 93,
        price: 6428,
        image_url: "https://ruhratna.com/wp-content/uploads/2026/04/123.webp",
        product_url: "https://ruhratna.com/shop/vasundhara-temple-kundan-heritage-choker-set/",
      },
      {
        product_id: "10207",
        title: "Mayurika – Royal Peacock Chandbali Statement Earrings",
        type: "ears",
        tier: 1,
        reason:
          "These dramatic peacock chandbali earrings will add a theatrical, festive flair that perfectly complements the saree heavy embellishment. The gold tones and intricate detailing create a cohesive traditional look.",
        match_score: 90,
        price: 2234,
        image_url: "https://ruhratna.com/wp-content/uploads/2026/04/123.webp",
        product_url: "https://ruhratna.com/shop/mayurika-royal-peacock-chandbali-statement-earrings/",
      },
      {
        product_id: "10841",
        title: "Shyamalika – Kundan Meenakari Statement Hand Ring",
        type: "hands",
        tier: 2,
        reason:
          "This ornate hand ring adds a finishing touch to the bridal look, with kundan and meenakari work that echoes the saree embellishment perfectly.",
        match_score: 85,
        price: 1249,
        image_url: "https://ruhratna.com/wp-content/uploads/2026/04/123.webp",
        product_url: "https://ruhratna.com/shop/shyamalika-kundan-meenakari-statement-hand-ring/",
      },
      {
        product_id: "10824",
        title: "Mrinalini – Royal Meenakari Kundan Statement Ring",
        type: "accent",
        tier: 2,
        reason:
          "A bold statement ring in royal meenakari adds the finishing touch to a heavily embellished wedding look.",
        match_score: 82,
        price: 1249,
        image_url: "https://ruhratna.com/wp-content/uploads/2026/04/123.webp",
        product_url: "https://ruhratna.com/shop/mrinalini-royal-meenakari-kundan-statement-ring/",
      },
    ],
    complete_look: {
      suggested: true,
      pieces: ["10869", "10207"],
      look_description:
        "The Rajnandini necklace set provides a rich, traditional foundation, while the Mayurika peacock earrings add a dramatic, festive flair that perfectly complements the saree heavy embellishment.",
      combined_price: 9599,
    },
  };
  ...
  function showOutfitCard(analysis) {
    $("outfit-type-display").textContent =
      `${analysis.dominant_colour || ""} ${analysis.outfit_type || ""}`.trim();

    $("chip-neckline").textContent = analysis.neckline           || "";
    $("chip-style"   ).textContent = analysis.style_weight       || "";
    $("chip-occasion").textContent = analysis.occasion_confirmed || "";
    ...
    card.innerHTML = `
      ...
      <div class="card-info">
        ...
        <div class="card-footer">
          ...
          <a href="${escapeHtml(rec.product_url)}"
